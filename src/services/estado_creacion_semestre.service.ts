...
import { EstadoCreacionSemestre as MainModel, EstadoCreacionSemestreDto as MainDto } from 'src/models/estado_creacion_semestre.dtoSchema';

@Injectable()
export class EstadoCreacionSemestreService {
    constructor(
